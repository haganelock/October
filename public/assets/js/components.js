...
class SliderDots {
	...
	_getDotTemplate() {
		return `
			<svg viewBox="0 0 265 2" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
				<g fill="none" fill-rule="evenodd"><g transform="">
					<path class="circle" d="M2,0h261c1.1,0,2,0.4,2,1l0,0c0,0.6-0.9,1-2,1H2C0.9,2,0,1.6,0,1l0,0C0,0.4,0.9,0,2,0z"></path>
				</g>
			</svg>
		`;
	}
