...
return [
    ...
    "checkout" => [
        ...
        "succeeded" => [
            ...
            "thanks_for_order" => "Grazie per aver acquistato il tuo Hagane.",
            "thanks_for_order_2" => "Il tuo ordine è il #:number, ti chiediamo di far riferimento a questo numero in caso di qualsiasi contatto con la nostra assistenza. "
                . "Ci puoi scrivere a <a href='mailto:info@hagane.it'>info@hagane.it</a>.",
            "thanks_for_order_3" => "Spediremo il tuo Hagane nel più breve tempo possibile, solitamente entro 1-3 giorni dalla data di acquisto. "
                . "Non appena sarà spedito, riceverai via email il tracking code della spedizione.",
            //"thanks_for_order" => "Grazie per aver acquistato Hagane.",
            //"thanks_for_order_2" => "Ti confermiamo che l'ordine è andato a buon fine.",
            //'thanks_for_order_3' => "Puoi vedere un riepilogo di seguito",
    ...
    "common" => [
        ...
        "view_order_in_backend" => "Visualizza il tuo ordine nel backend del negozio",
    ...
    "order" => [
        ...
        "state_changed" => [
            "message" => "Il tuo ordine **#:number** è stato aggiornato al nuovo stato: **:state**",
    ...
    "payment" => [
        ...
        "refunded" => [
            "duration" => "La transazione potrebbe impiegare fino a 15 giorni lavorativi per essere rimborsata: non dipende da noi ma dal gestore di pagamenti (gateway) dei pagamenti e dai circuiti (Visa, Mastercard, etc…).",
