<?php return [
    ...
    'common' => [
        ...
        'showcase' => 'Vetrina',
        'showcase_title' => 'Titolo',
        'showcase_image' => 'Immagine',
        'showcase_detail' => 'Dettaglio / Descrizione',
        'specs' => 'Specifiche',
        'specs_color' => 'Colore',
        'specs_size' => 'Dimensioni',
        'specs_weight' => 'Peso',
        'specs_warranty' => 'Garanzia'
    ],
    'variant' => [
        'method' => [
            'single' => 'Articolo',
        ...
        'signup' => [
            ...
            'errors' => [
                ...
                'login' => [
                    ...
                    'between' => 'Inserisci un indirizzo email valido',
                ],
                'password' => [
                    'required' => 'Inserisci la tua password',
                    'max' => 'La password fornita é troppo lunga',
                    'min' => 'La password fornita é troppo corta Inserisci almeno 8 caratteri',
                ],
                'password_repeat' => [
                ...
                'terms_accepted' => [
                    'required' => 'Devi accettare i nostri termini e condizioni',
                ],
                'fiscal_code' => [
                    'required' => 'Inserisci un codice fiscale o una partita iva valida',
                ],
                'company_name' => [
                    'required' => 'Inserisci un nome azienda valido',
                ],
                'phone_number' => [
    ...
    'stripe' => [
        'card_number_incomplete' => 'Il numero di carta di credito non è completo.',
        'card_number_invalid' => 'Il numero di carta di credito non è valido.',
        'expiration_date_incomplete' => 'La data scadenza della carta di credito non è valida.',
        'security_code_incomplete' => 'Il security code della carta di credito non è valido.',
        'unexpected_error' => 'Errore imprevisto: ',
        'postal_code_incomplete' => 'Il codice postale è incompleto.',
    ],
    'user' => [
        'fields' => [
            'company_name' => 'Azienda',
            'fiscal_code' => 'Codice fiscale / Partita iva',
